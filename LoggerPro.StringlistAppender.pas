...
unit LoggerPro.StringListAppender;
...
constructor TStringListLogAppender.Create(aStringList: TStrings; aMaxLogLines:
...
destructor TStringListLogAppender.Destroy;
begin
...
procedure TStringListLogAppender.WriteLog(const aLogItem: TLogItem);
var
  lText: string;
begin
      ...
      try
        ...
        try
          if FMaxLogLines > 0 then
            while fStringList.Count > FMaxLogLines do
              fStringList.Delete(0);
          fStringList.Add(lText)
        finally
